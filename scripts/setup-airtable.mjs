...
const mulligansSeed = {
  ...
  'Recurrence Label': 'Normally every Thursday',
  'Time Label': '6:30 PM',
...
const momentSeeds = [
  ...
  },
  {
    ...
    'Image URL': 'https://www.rainingentertainment.com/media/about/jolie-shaka-balloons-portrait.webp',
    'Post URL': 'https://www.instagram.com/cirquejolie/',
    Account: '@cirquejolie',
    'Alt Text': 'Jolie Strickland throwing a shaka from a ring of colorful twisting balloons',
    Service: 'Cirque',
    'Sort Order': 2,
    Published: true,
  },
  ...
  },
  {
    ...
    'Image URL': 'https://www.rainingentertainment.com/media/casino-gameshow/brenton-craps-gameshow-fanatics-portrait.webp',
    'Post URL': 'https://www.instagram.com/gameshowfanatics/',
    Account: '@gameshowfanatics',
    'Alt Text': 'Brenton Keith behind the Gameshow Fanatics craps table at a Maui Casino NITE',
