export const SITE = Object.freeze({
  ...
  defaultImage: '/media/hero-reigning-entertainment.webp',
  socialProfiles: [
...
const routes = [
  {
    ...
    imageAlt: 'Raining Entertainment performers delighting guests at a Maui event',
    pageType: 'WebPage',
    schemaKind: 'website',
    priority: '1.0',
    changefreq: 'weekly',
  },
  {
    ...
    description:
      'Book Cirque Jolie for Maui balloon twisting, face painting, interactive children’s magic and party entertainment for birthdays, baby luaus and family events.',
    image: '/media/balloons/balloon-animals-fish-maui.webp',
    imageAlt: 'Colorful balloon twisting created by Cirque Jolie on Maui',
    pageType: 'WebPage',
    schemaKind: 'service',
    serviceName: 'Balloon Twisting and Face Painting',
    serviceType: 'Balloon twisting, face painting, children’s magic and kids party entertainment',
    priority: '0.9',
    changefreq: 'monthly',
  },
  {
    ...
    imageAlt: 'Candy-themed balloon stage installation created by Cirque Jolie',
    pageType: 'WebPage',
    schemaKind: 'service',
  ...
  {
    path: '/strolling',
    title: 'Maui Costumed Stilt Walking | Cirque Jolie',
    description:
      'Transform a Maui event with Cirque Jolie stilt walkers, fire and LED performers, themed characters and vibrant strolling entertainment for every age.',
    image: '/media/strolling/cirque-jolie-balloon-stilt-maui.webp',
    imageAlt: 'Cirque Jolie in a dramatic balloon stilt costume at a Maui event',
    pageType: 'WebPage',
    schemaKind: 'service',
    serviceName: 'Costumed Stilt Walking',
    serviceType: 'Stilt walkers, fire performers, LED dancers and strolling characters',
    priority: '0.9',
    changefreq: 'monthly',
  },
  {
  ...
  },
  {
    ...
    image: '/media/hero-reigning-entertainment.webp',
    imageAlt: 'Raining Entertainment performers at a Maui event',
    pageType: 'WebPage',
    schemaKind: 'website',
  ...
  },
  {
    ...
    title: 'Maui Event Entertainment Add-Ons | Raining Entertainment',
    description:
      'Complete your Maui event with emcees, DJs, sound, lighting, themed performers and custom entertainment add-ons from one experienced local team.',
    image: '/media/cirque-jolie-gameshow-fanatics-1.jpg',
    imageAlt: 'Raining Entertainment performers together at a Maui event',
    pageType: 'WebPage',
    schemaKind: 'service',
    serviceName: 'Maui Event Entertainment Add-Ons',
    serviceType: 'Emcees, DJs, sound, lighting and themed entertainment add-ons',
    priority: '0.7',
    changefreq: 'monthly',
  },
  {
    ...
    image: '/media/about/brent-umbrella-beach.jpg',
    imageAlt: "Brenton Keith of Brenton Keith & His Bag O' Tricks on a Maui beach",
    pageType: 'AboutPage',
    schemaKind: 'people',
    priority: '0.8',
    changefreq: 'yearly',
  },
  {
    ...
    image: '/media/hero-reigning-entertainment.webp',
    imageAlt: 'Raining Entertainment at an outdoor Maui celebration',
  ...
  },
  {
    ...
    description:
      'Discover Cirque Jolie’s costumed stilt walking, balloon twisting and decor, face painting, children’s magic, fire performers and themed characters.',
    image: '/media/about/jolie-strickland-portrait.webp',
    imageAlt: 'Jolie Strickland in a colorful Cirque Jolie costume',
...
function personSchemas() {
  return [
    ...
    },
    {
      ...
      image: absoluteUrl('/media/about/jolie-strickland-portrait.webp'),
      worksFor: { '@id': `${SITE.origin}/#organization` },
      sameAs: [
        'https://www.instagram.com/cirquejolie/',
        'https://www.facebook.com/cirquejolie',
  ...
  if (metadata.schemaKind === 'service' || metadata.schemaKind === 'cirque') {
    ...
    graph.push({
      ...
      serviceType:
        ...
        'Stilt walking, balloons, face painting, children’s magic and ambient performers',
      description: metadata.description,
      url,
      image,
