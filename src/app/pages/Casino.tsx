      ...
      <section id="tables" className="py-24 bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {[
              { src: '/media/casino-gameshow/brenton-craps-gameshow-fanatics-wide.webp', alt: 'Brenton Keith behind the Gameshow Fanatics craps table at a Maui Casino NITE', title: 'Craps', desc: 'The most social game in the house — the whole table cheers together.' },
