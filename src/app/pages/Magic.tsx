...
export default function Magic() {
  ...
  return (
    <Layout title="Brenton Keith & His Bag O' Tricks">
      ...
      <div ref={heroRef} className="relative min-h-[calc(100svh-5rem)] overflow-hidden flex items-end md:h-[85vh]">
        <motion.div style={{ y: heroY }} className="absolute inset-0">
          <SmartBackgroundVideo
            desktopSrc="/media/video/magic-brent-hero.mp4"
            mobileSrc="/media/video/magic-brent-hero-mobile.mp4"
            poster="/media/magic/magic-brent-live-show-maui.webp"
          />
        ...
        <div className="relative z-10 container mx-auto px-4 py-14 md:py-0 md:pb-20">
          <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: 'easeOut' }}>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-8xl font-black mb-6 leading-[0.9]">
              ...
              <br /><span className="text-white/90 text-2xl md:text-5xl font-light">Comedy Magic &amp; Entertainment for Hire</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <FadeInSection>
              <div className="relative">
                <img src="/media/magic/brent-umbrella-beach.jpg" alt="Brenton Keith on the beach with cards raining down" loading="lazy" decoding="async" className="rounded-3xl shadow-2xl shadow-coral/10 w-full object-cover aspect-[4/5]" />
            ...
            <FadeInSection delay={0.2}>
              ...
              <p className="text-gray-400 leading-relaxed mb-8">He&rsquo;s performed for several thousand birthday parties, 1st Birthday Luaus, Maui weddings, and corporate events all over Hawaii. He&rsquo;s also the Host, Producer, and Owner of <Link to="/game-show" className="text-coral hover:underline">Gameshow Fanatics</Link>, Hawaii&rsquo;s premier portable game show.</p>
      ...
      <section className="py-24 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Sparkles className="w-8 h-8" />, title: 'Live Magic Shows', desc: 'Professional magic shows on Maui — high-energy comedy & magic with tons of laughs and interaction, perfect for all ages. You\'ll see live goldfish. You\'ll see fire. You\'ll see your friends, coworkers, or the birthday boy or girl on stage! Whether indoor or outdoor, Brenton brings everything you need for a great time.', img: '/media/magic/magic-brent-live-show-maui.webp', imgAlt: 'Brenton Keith performing a formal live comedy magic show at Mulligan\'s on the Blue in Wailea' },
              { icon: <Wand2 className="w-8 h-8" />, title: 'Up-Close Magic', desc: 'Polished tableside magic that happens right in your guests\' hands. Cards, coins, and mind-reading — perfect for cocktail hours, receptions, and corporate mixers where conversation and amazement blend seamlessly.', img: '/media/487409844_1105269438282575_227576139539312597_n.jpg', imgAlt: 'Brenton Keith performing tableside up-close magic at Mulligan\'s on the Blue Wailea' },
              { icon: <Heart className="w-8 h-8" />, title: 'Birthdays & 1st Birthdays', desc: 'The best choice for 1st birthday parties on Maui. Brenton has amused & amazed at thousands of Maui magic shows and 1st Birthday Luaus. Age-appropriate comedy magic with family-friendly jokes that keep little ones laughing.', img: '/media/481701426_1083132873829565_1351071441168869141_n.jpg', imgAlt: 'Maui magician Brenton Keith performing for kids with Rubik\'s cubes at outdoor festival' },
            ].map((style, i) => (
              <FadeInSection key={i} delay={i * 0.15}>
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-slate-700/50 hover:border-coral/20 transition-all group h-full">
                  <div className="aspect-[3/2] overflow-hidden">
                    <img src={style.img} alt={style.imgAlt} loading="lazy" decoding="async" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="p-8">
      ...
      <section className="py-24 bg-slate-900">
        <div className="container mx-auto px-4">
          <FadeInSection className="text-center mb-16">
            <p className="text-coral font-semibold tracking-widest uppercase text-sm mb-3">Brenton Keith &amp; His Bag O&rsquo; Tricks in Action</p>
            ...
            {[
              ...
              <FadeInSection key={i} delay={i * 0.08}>
                <div className="rounded-2xl overflow-hidden group aspect-[4/3]">
                  <img src={photo.src} alt={photo.alt} loading="lazy" decoding="async" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              </FadeInSection>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <FadeInSection delay={0.2}>
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {['Birthdays', '1st Birthday Luaus', 'Corporate Events', 'Maui Weddings', 'Up-Close Magic', 'Cocktail Hours', 'Resort Entertainment', 'Private Luaus', 'Holiday Parties', 'Fundraisers', 'School Events', 'Restaurant Shows'].map((event, i) => (
